...
prov_poly_t = cbind(prov_poly,data)
prov_poly_t = as_Spatial(prov_poly_t)
com_poly_t = as_Spatial(com_poly)
discr_prov1 = discretizePolygon(prov_poly_t,cellsize = 4000,id = "DEN_PCM",value = "PC1",showProgressBar = T)
discr_prov2 = discretizePolygon(prov_poly_t,cellsize = 4000,id = "DEN_PCM",value = "PC2",showProgressBar = T)
discr_prov3 = discretizePolygon(prov_poly_t,cellsize = 4000,id = "DEN_PCM",value = "PC3",showProgressBar = T)
discr_com = discretizePolygon(com_poly_t,cellsize = 2000,id = "PRO_COM",showProgressBar = T)
...
save(ata1,ata2,ata3, deconv1, deconv2, deconv3, deconv, file = Rdata_path(paste0("temp_downscaling",class) ))
